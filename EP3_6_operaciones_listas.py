...
print()
print("3.6.1 Asignación de listas")
list_1 = [1]
list_2 = list_1
list_1[0] = 2
print("list_1 =", list_1)
...
print()
print("3.6.3 Rebanadas con índices negativos")
print(my_list[1:-1])
print(my_list[:3])
print(my_list[3:])
print(my_list[:])
...
my_list = [21, 4, 18, 7, 2, 11, 9, 15, 13]
largest = my_list[0]
...
print()
print("Coincidencias en una lista")
drawn = [4, 12, 8, 25, 31, 40]
bets = [8, 9, 12, 17, 31, 45]
hits = 0
